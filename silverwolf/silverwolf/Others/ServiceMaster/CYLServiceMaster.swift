...
//        }
//        AF.request(rqst.serviceURL, method: serviceMethod!, parameters: rqst.paramDictionary , headers: rqst.headerDictionary).responseData
//                {
//                    response in
//
...
//      {
//          let headers: HTTPHeaders = ["Authorization": "Bearer \(ATUserDefaults.ATshared.apiAccessToken)","Content-Type" : "application/x-www-form-urlencoded"]
//          
...
//                     multipart.append(obj.imageData! as Data, withName: obj.imageKey, fileName: "file.png", mimeType: "image/png")
//                 
//                 for (key, value) in parameters!{
//                     multipart.append(value as! String).data(using: .utf8)!, withName: key)
//                 }
//             },usingThreshold: UInt64.init(),
//                    to: APIUrl.UserApis.attachmentUploadData,
//                method: .post,
//                headers: headers,
